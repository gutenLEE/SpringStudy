...
public class BoardVO {
	...
	public String toString() {
		return "BoardVO [num=" + num + ", id=" + id + ", subject=" + subject + ", content=" + content + ", file=" + file
				+ ", org_file=" + org_file + ", up_file=" + up_file + ", re_ref=" + re_ref + ", re_lev=" + re_lev
				+ ", re_seq=" + re_seq + ", readcount=" + readcount + ", boarddate=" + boarddate + "]";
	}
