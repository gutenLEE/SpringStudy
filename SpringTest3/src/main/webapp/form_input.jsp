...
<!-- <script type="text/javascript" src="./resources/js/form_input.js" charset="utf-8"></script>  -->
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/form_input.js" charset="utf-8"></script>
</head>
<body>
<!-- form  -->
