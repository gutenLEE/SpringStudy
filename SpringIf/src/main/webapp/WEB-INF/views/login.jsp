...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/LeeCSS.css" type="text/css">
...
<body>
	...
	<script>
		...
		function loginValidate(id, pw){
			...
			console.log('dd', id.value, pw.value);
			
 			$.ajax({
			    url: "/springif/loginCheck", 
			    data: { "id": id.value,
			    		"pw": pw.value},  
			    type: "POST",                    
